...
### Sprint 20 — Dashboard operativo (fase 1)
- Construir vista central tipo dashboard para el admin con KPIs del día.
- Mostrar pedidos recientes, estado de pedidos y top productos de los últimos 7 días.
- Incluir accesos rápidos a módulos críticos (Pedidos, Reportes, Clientes).

### Sprint 21 — Automatización comercial
...
### Sprint 22 — Cierre de ciclo y despliegue
