...
- **Panel admin:** `cd PROYECTO_DPASO/dpaso-admin && npm install && npm run dev`
- **Proyecto principal (carta + backend):** revisar scripts y migraciones en `PROYECTO_DPASO/Carta-Dpaso-main`.
