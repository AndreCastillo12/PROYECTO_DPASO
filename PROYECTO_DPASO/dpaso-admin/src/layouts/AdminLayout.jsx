...
const NAV_ITEMS = [
  { to: "/dashboard", label: "Dashboard", icon: FiGrid, area: "dashboard" },
  ...
  { to: "/categorias", label: "Categorías", icon: FiSettings, area: "categorias" },
  { to: "/tienda", label: "Horarios", icon: FiClock, area: "tienda" },
  { to: "/zonas-delivery", label: "Zonas", icon: FiMapPin, area: "zonas-delivery" },
];
...
export default function AdminLayout() {
  ...
  const visibleNavItems = useMemo(() => NAV_ITEMS.filter((item) => !item.area || canAccess(item.area)), [canAccess]);
    ...
    <div className="admin-shell">
      ...
      <section className="admin-content-area">
        ...
        <main className="admin-page-wrap">
          {loadingRole ? <p>Cargando permisos...</p> : <Outlet />}
        </main>
      </section>
    </div>
  );
