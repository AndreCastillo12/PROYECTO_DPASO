      ...
      <div className="nav-mobile" style={{ display: "none", position: "relative" }}>
        ...
        {menuOpen && (
          <div style={{
            ...
            <NavLink to="platos" style={linkStyle} onClick={() => setMenuOpen(false)}>Gestión de Platos</NavLink>
            <NavLink to="categorias" style={linkStyle} onClick={() => setMenuOpen(false)}>Gestión de Categorías</NavLink>
            <NavLink to="perfil" style={linkStyle} onClick={() => setMenuOpen(false)}>Perfil</NavLink>
            <button onClick={cerrarSesion} style={{ ...logoutBtn, marginTop: "10px" }}>Cerrar Sesión</button>
          </div>
        )}
      </div>
