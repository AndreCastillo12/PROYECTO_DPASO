...
const STATUS_META = {
  pending: { label: "Nuevo pedido", className: "new" },
  ...
  completed: { label: "Completado", className: "green" },
                    ...
                    <div className="row-actions">
                      ...
                      {openMenuOrderId === order.id ? (
                        <div className="row-menu">
                          <button type="button" onClick={() => onChangeStatus(order, "pending")}>Marcar pendiente</button>
                          <button type="button" onClick={() => onChangeStatus(order, "accepted")}>Aceptar pedido</button>
                          <button type="button" onClick={() => onChangeStatus(order, "preparing")}>En preparación</button>
                          <button type="button" onClick={() => onChangeStatus(order, "ready")}>Marcar listo</button>
                          <button type="button" onClick={() => onChangeStatus(order, "dispatched")}>En reparto</button>
                          <button type="button" onClick={() => onChangeStatus(order, "delivered")}>Entregado</button>
                          <button type="button" onClick={() => onChangeStatus(order, "completed")}>Completado</button>
                          <button type="button" onClick={() => onChangeStatus(order, "cancelled")}>Cancelar pedido</button>
