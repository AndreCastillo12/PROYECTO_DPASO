...
export default function Usuarios() {
  ...
  const createBaseUser = async () => {
    ...
    showToast("Usuario base creado en Auth. Ahora puedes asignarle rol desde este panel.", "success");
    setBusy(false);
  };
  ...
  if (loading) return <p>Cargando roles y usuarios...</p>;
    ...
    <div style={{ display: "grid", gap: 14 }}>
      ...
      <section style={card}>
        ...
        <div style={{ display: "grid", gap: 8, marginTop: 10 }}>
          {managedUsers.length === 0 ? <p style={{ color: "#6b7280" }}>No hay otros usuarios internos con rol asignado.</p> : managedUsers.map((u) => (
