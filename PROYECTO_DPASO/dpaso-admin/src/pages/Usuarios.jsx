          ...
          {managedUsers.length === 0 ? <p style={{ color: "#6b7280" }}>No hay otros usuarios internos para gestionar.</p> : managedUsers.map((u) => (
            <div key={u.user_id} style={rowStyle}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end" }}>
                ...
                <button type="button" style={btnDanger} disabled={busy || currentRole !== "admin"} onClick={() => deleteInternalUser(u.user_id, u.email)}>Eliminar cuenta completa (correo)</button>
              </div>
            </div>
          ))}
        </div>
