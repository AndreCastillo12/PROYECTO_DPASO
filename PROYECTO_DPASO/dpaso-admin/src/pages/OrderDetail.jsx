    ...
    <div className="order-detail-sedap-page">
      <header className="order-detail-header">
        <div>
          ...
          <p><span>Orders</span> / Order Details</p>
        </div>

        <div className="order-detail-header-actions">
          <button type="button" className="btn-outline-red" onClick={() => updateStatus("cancelled")} disabled={updating}>Cancel Order</button>
      ...
      <div className="order-detail-grid">
        <aside className="order-left-col">
          <article className="customer-card">
            ...
            <span className="mini-badge">Customer</span>
          </article>

          <article className="note-card">
            <h5>Note Order</h5>
            <p>{selectedOrder.comentario || "Sin nota por ahora."}</p>
          ...
          <article className="history-card">
            <h5>History</h5>
            <ul>
              <li><span className="dot done" /> Order Created</li>
              <li><span className="dot done" /> Payment {selectedOrder.paid ? "Success" : "Pending"}</li>
              <li><span className="dot current" /> {humanStatus(selectedOrder.estado)}</li>
            </ul>
          </article>
        </aside>
          ...
          <article className="track-card">
            ...
            <div className="delivery-footer">
              ...
              <div className="delivery-contact-actions">
                <button type="button" onClick={notifyWhatsApp}><FiPhone size={14} /> Teléfono</button>
