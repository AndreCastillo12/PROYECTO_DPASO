...
export default function Caja() {
  ...
  useEffect(() => {
    async function loadOpenedByName() {
  ...
  }, [movements, movementFilterMethod, movementFilterSource, movementFilterType]);
          ...
          <section style={cardStyle}>
            ...
            {!openSession ? (
              ...
              <div style={{ display: "grid", gap: 8 }}>
                ...
                <p style={{ margin: 0 }}><strong>Usuario apertura:</strong> {openedByName}</p>
          ...
          {openSession ? (
            <>
              ...
              <section style={cardStyle}>
                ...
                <p style={{ margin: "8px 0 0", color: differenceTone === "neutral" ? "#6b7280" : differenceTone === "ok" ? "#1f7a43" : "#6b7280" }}>
                  {differenceTone === "neutral"
                    ? "Ingresa el efectivo contado para calcular diferencia"
                    : differenceTone === "ok"
                      ? "Cuadre OK (diferencia 0.00)"
                      : "Diferencia registrada. Se guardará en el cierre."}
                </p>
