...
export default function Caja() {
  ...
  const previewDifference = useMemo(() => {
    ...
    const expected = Number(summary?.expected_amount);
    if (!Number.isFinite(amount) || !Number.isFinite(expected)) return null;
    return amount - expected;
  }, [closingAmount, summary?.expected_amount]);
