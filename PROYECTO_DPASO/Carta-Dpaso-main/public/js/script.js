...
function applyAuthUi(user = null) {
  ...
  if (accountBtn) accountBtn.textContent = 'Mi cuenta';
...
function setupAuthEvents() {
  ...
  const accountMenuModal = document.getElementById('account-menu-modal');
  ...
  function openAccountMenuModal() {
    openModalSafe(accountMenuModal, accountOpenProfile);
  }

  function closeAccountMenuModal() {
    closeModalSafe(accountMenuModal, getFallbackFocusElement('auth-account-btn'));
  }
  ...
  bindScopedListener(scope, accountMenuClose, 'click', closeAccountMenuModal, {}, 'auth:menu-close');
